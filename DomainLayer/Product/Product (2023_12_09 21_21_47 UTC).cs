...
namespace Domainlayer.Product
{
    public  class Product : AggregateRoot
    {
        ...
        private Product (Productid id, string name,string description, ProductAttributes productAttributes,string categoryid,string subcategoryid, Type type, double cost) 
        {
            this.Productid = id;
        ...
        public void Addpicture(Guid id , string url,string productid) 
        {
