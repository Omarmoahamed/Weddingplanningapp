...
namespace Domainlayer.Product
{
    public  class Product : AggregateRoot<Productid>
    {
        ...
        private Product (Guid id, string name,string description, ProductAttributes productAttributes,string categoryid,string subcategoryid, Type type) 
        {
        ...
        public static Product createproduct(Guid id, string name, string description, string categoryid, string subcategoryid, string Attributevalue,string attributename,IfindProductAttribute findProductAttribute,byte? type) 
        {
            ...
            return new Product(id, name, description,ProductAttributes.createAttribute(attributename, Attributevalue, findProductAttribute), categoryid, subcategoryid, (Type)Enum.ToObject(typeof(Type), type));
        }
